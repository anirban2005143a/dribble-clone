...
export const Header = ({ title, user }) => {
  ...
  return (
    <section
      className={`${height == undefined ? "relative" : `sticky`} bg-white w-full mt-17.5 pb-3 z-1 lg:px-0 px-4`}
      ...
      <div className="max-w-237.5 mx-auto ">
        ...
        <div className="flex items-center gap-3 w-full">
          ...
          <div className="flex items-center gap-3 w-auto">
            ...
            <div className="flex items-center md:justify-normal justify-between text-sm">
          ...
          {/* Right Section */}
          <div className="flex flex-1 items-center justify-between md:gap-4 gap-2 mr-2">
